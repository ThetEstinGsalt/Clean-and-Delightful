...
def blog(request, sno):
    ...
    return render(request, 'blog.html', {'blog': blog.first(), 'affiliate': affiliate1.first(), 'recomendation': lastest, 'prev0': blog_prev_title, 'prev1': blog_prev_image, 'prev': prevs, 'next': nexts, 'next0': blog_next_title, 'next1': blog_next_image})
